...
exports.handler = async function (event, context, callback) {
  ...
  try {
    switch (event.field) {
      case "createCategory":
        response = await createCategory(event.body, event.identity);
        break;
      case "updateCategory":
        response = await updateCategory(event.body, event.identity);
        break;
      case "deleteCategory":
        response = await deleteCategory(event.body, event.identity);
        break;
    }
  } catch (e) {
 ...
 * Create Category
 **************************************************************/
createCategory = async (body, identity) => {
  const id = nanoid();
 ...
 * Update Record
 **************************************************************/
updateCategory = async (body, identity) => {
 ...
 * Delete Category
 **************************************************************/
deleteCategory = async (body,identity ) => {
